...
async function withdrawMaster() {
    ...
    try {
        const payload = {
            ...
            amount: "0.2" // Assuming 0.2 USDC or similar is sufficient. If it fails, maybe the balance is less.
        };

        console.log(`Sending Gateway Withdraw Request...`, payload);
        ...
        if (e.response) {
            ...
            if (e.response.status === 404) {
                console.error("The endpoint /agent/gateway-withdraw was not found. Render might still be deploying!");
            }
        } else {
